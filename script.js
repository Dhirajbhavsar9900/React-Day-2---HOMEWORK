...
const anchorTag3 = React.createElement("a",{href:"#" , class:"text-blue-500"},"CSS-Styling the web")
...
const anchorTag2 = React.createElement("a",{href:"#" ,class:"anchor1 a"},"HTML — Structuring the web")
const p2 = React.createElement("p",{class:""},"Provides a practical introduction to web development for complete beginners.")
const anchorTag1 = React.createElement("a",{href:"#" ,class:"text-blue-500"},"Getting started with the web")
